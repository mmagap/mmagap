ActiveAdmin.setup do |config|
  ...
  config.namespace :admin do |admin|
    admin.build_menu do |menu|
      menu.add :label => "Application", :priority => 0 do |site_view|
       site_view.add :label => "View", :url => "/videos", :html_options => { :target => :blank }, :priority => 0
      end

      #menu.add :label => "Sites" , :priority => 0 do |sites|
